...
All candidates are pre-loaded. Your job: first call get_top_candidates to anchor the cycle, then pick the highest-conviction candidate and call deploy_position. active_bin is pre-fetched.
