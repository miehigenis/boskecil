...
export async function recordPerformance(perf) {
  ...
  // Evolve thresholds every 5 closed positions (only if autoEvolve is enabled)
  if (config.darwin?.autoEvolve !== false && data.performance.length % MIN_EVOLVE_POSITIONS === 0) {
